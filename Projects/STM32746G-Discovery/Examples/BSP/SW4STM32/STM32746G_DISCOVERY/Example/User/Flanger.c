...
float32_t manual_f = 55, rate_f = 0.2, depth_f = 8, feedback_f = -0.95;
...
float32_t flanger (float32_t entrada)
{
	...
	d_f = (int) floor((double)demora_f + 20);
	...
	d_f = (int) floor((double)demora_f + 40);
	...
	d_f = (int) floor((double)demora_f + 60);
	...
	d_f = (int) floor((double)demora_f + 80);
	...
	salida_f = (aux5_f + aux4_f + aux3_f + aux2_f + aux1_f + entrada)*0.35;
	//salida_f = entrada;
	return salida_f;
}
