...
int modulacion_t = SINUSOIDAL, state_t = 0;
...
void Tremolo_Rate (GUIElement *e)
{
...
void Tremolo_Depth (GUIElement *e)
{
	DialButtonState *db = (DialButtonState *) (e->userData);
...
void Push_State_Tremolo (GUIElement *e)
{
	state_t = e->state;
}
